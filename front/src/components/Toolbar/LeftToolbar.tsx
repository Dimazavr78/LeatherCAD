...
function getToolId(tool: ToolConfig): Tool | null {
    return tool.id === 'select' || tool.id === 'rectangle' ? tool.id : null;
}
                    ...
                    <div className="tool-list">
                        {tools
                            ...
                            .map((tool) => {
                                ...
                                const label =
                                    tool.localization.enabled &&
                                    tool.localization.label
                                        ? t(tool.localization.label)
                                        : (tool.label ?? tool.id);
                                const tooltip =
                                    tool.localization.enabled &&
                                    tool.localization.tooltip
